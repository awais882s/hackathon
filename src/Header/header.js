        ...
        <div>
            <header id="alert-header">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="alert alert-info mb-0 px-0 alert-dismissible fade show border-0" role="alert">
                                HURRY ! Check Out Our New Products <a href="javascript:void(0)" class="alert-link">Check Now</a>
                ...
                >
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="https://fiverr-res.cloudinary.com/videos/t_main1,q_auto,f_auto/tkf7agzwy0nkvwwtysxb/design-your-shopping-store-banner-sliders.png" class="d-block w-100" alt="place" />
                        ...
                        <div class="carousel-item">
                            <img src="https://i.pinimg.com/originals/79/98/e4/7998e4aa36f6bf78c6b15d6d30e279cf.jpg" class="d-block w-100" alt="girls" />
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item">
                            <img src="https://i.pinimg.com/originals/b6/c9/17/b6c9173bd58f62f49eb550635a5e259f.jpg" class="d-block w-100" alt="nature" />
                            <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12 col-md-10 offset-md-1 text-center">
                                    ...
                                    <p>
                                        ...
                                        culpa. Ad et a quam nisi, dicta, eius excepturi unde, voluptas
                                        laborum eaque iure?
                                    </p>
                                </div>
                            </div>
                ...
                <div class="py-5 faqs">
                    <div class="container">
                        <div class="conatiner">
                            <div class="row mb-4">
                                <div
                                    class="col-sm-12 col-md-10 offset-md-1 text-center text-white"
                                >
                                    <h1>Our FAQ,s</h1>
                                    <p>
                                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Esse
